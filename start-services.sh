...
# start-services.sh - Script to start n8n, caddy, and portainer services
...
# Starting services without profile selection
echo "Starting services (n8n, caddy, and portainer)..."
python3 start_services.py --profile none
...
# Comment out services we're not using
